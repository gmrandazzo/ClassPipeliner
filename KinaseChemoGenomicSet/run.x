...
python3 make_model.py dataset.morgan_ecfp.csv PKIS2.csv
mkdir RDKitECFPMorganFP;
mv *.json *.png RDKitECFPMorganFP

rm rdkit_desc_table_results.csv
echo "Kin-Method,AVG-PR,ROC-AUC,Acc,Emission(kW)" >> rdkit_desc_table_results.csv
...
echo "Kin-Method,AVG-PR,ROC-AUC,Acc,Emission(kW)" >> rdkit_ecfp_table_results.csv
